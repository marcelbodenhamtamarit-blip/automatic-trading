"""
=============================================================================
PAPER TRADER v2 - Con gestion de riesgo de cartera + señal de noticias
=============================================================================
Basado en la v2 original. La unica diferencia es que evaluate() ahora
tambien recibe el ticker, para poder consultar noticias via news.py.
...
2. TOPE POR SECTOR: maximo 2 posiciones del mismo sector.
...
COMPATIBLE con state.json de versiones anteriores.
=============================================================================
"""
...
def build_summary(state, events, today, mtm, bullish, cfg):
    ...
    lines = [
        f"PAPER TRADING v2 + Noticias | {today} | Regimen: {regime}",
